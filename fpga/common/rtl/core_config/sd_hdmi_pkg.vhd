...
-- File: sd_hdmi_pkg.vhd - SD HDMI Core Configuration
...
--
-- Description:
--   Core configuration package for SD HDMI video mode.
--   Enables HDMI output at SD resolution with no clock division.
--
-- Authors:
--   Lars Larsen
