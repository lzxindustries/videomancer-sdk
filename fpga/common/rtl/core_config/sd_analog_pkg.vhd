...
-- File: sd_analog_pkg.vhd - SD Analog Core Configuration
...
--
-- Description:
--   Core configuration package for SD analog video mode.
--   Enables analog output at SD resolution with no clock division.
--
-- Authors:
--   Lars Larsen
