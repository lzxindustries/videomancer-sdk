...
-- File: hd_hdmi_pkg.vhd - HD HDMI Core Configuration
...
--
-- Description:
--   Core configuration package for HD HDMI video mode.
--   Enables HDMI output at HD resolution with no clock division.
--
-- Authors:
--   Lars Larsen
